...
public class SchoolController {
    ...
    public List<School> findAllSchools() {
        if(schoolService.showAllSchools().isEmpty()){ //Si la lista con el parámetro school no encuentra ningún registro en el showAllSchools lanzará una excepción
            throw new RuntimeException("No hay registro de centros educativos"); //Excepción manejada dentro del package error
        }
    ...
    public Optional<School> findSchoolByName(@PathVariable String name) { //Se utiliza un PathVariable para tomar de referencia la variable a buscar
        if(schoolService.findSchoolByName(name).isEmpty()){
            throw new RuntimeException("El centro educativo ingresado no se encuentra registrado");//Excepción manejada dentro del package error
        }
    ...
    public Optional<School> findSchoolByProvince(@PathVariable String province) { //Se utiliza un PathVariable para tomar de referencia la variable a buscar
        if(schoolService.findSchoolByProvince(province).isEmpty()){
            throw new RuntimeException("La provincia ingresada por centro educativo no se encuentra registrada");//Excepción manejada dentro del package error
        }
    ...
    public Optional<School> findSchoolByCity(@PathVariable String city) { //Se utiliza un PathVariable para tomar de referencia la variable a buscar
        if(schoolService.findSchoolByCity(city).isEmpty()){
            throw new RuntimeException("El cantón ingresado por centro educativo no se encuentra registrado");//Excepción manejada dentro del package error
        }
    ...
    public Optional<School> findSchoolByDistrict(@PathVariable String district) { //Se utiliza un PathVariable para tomar de referencia la variable a buscar
        if(schoolService.findSchoolByDistrict(district).isEmpty()){
            throw new RuntimeException("El distrito ingresado por centro educativo no se encuentra registrado");//Excepción manejada dentro del package error
        }
    ...
    public Optional<School> findSchoolByCode(@PathVariable String code) { //Se utiliza un PathVariable para tomar de referencia la variable a buscar
        ...
        if(schoolService.findSchoolByCode(code).isEmpty()){ //si no se encuentra vacío el código del centro educativo se lanza la excepción
            throw new RuntimeException("El código ingresado por centro educativo no se encuentra registrado");//Excepción manejada dentro del package error
        }
    ...
    public School addSchool(@RequestBody School school) { //se utiliza el @request body unicamente para métodos controladores con la entity School para
        ...
        if(school.getSchoolName() == null || school.getSchoolName().isEmpty()) {
            throw new RuntimeException("Debe ingresar un nombre al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolProvince() == null || school.getSchoolProvince().isEmpty()) {
            throw new RuntimeException("Debe ingresar una provincia al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolCity() == null || school.getSchoolCity().isEmpty()) {
            throw new RuntimeException("Debe ingresar un cantón al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolDistrict() == null || school.getSchoolDistrict().isEmpty()) {
            throw new RuntimeException("Debe ingresar un distrito al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolEmail() == null || school.getSchoolEmail().isEmpty()) {
            throw new RuntimeException("Debe ingresar un email al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolCode() == null || school.getSchoolCode().isEmpty()) {
            throw new RuntimeException("Debe ingresar un código al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolTelephoneNumber() == null || school.getSchoolTelephoneNumber().isEmpty() ||
            ...
            throw new RuntimeException("Debe ingresar un número telefónico al centro educativo");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolQuantityTeachers() <= 0){
            throw new RuntimeException("La cantidad de profesores no puede ser nula");//Excepción manejada dentro del package error
        }
        ...
        if(school.getSchoolQuantityStudents() <= 0){
            throw new RuntimeException("La cantidad de estudiantes no puede ser nula");//Excepción manejada dentro del package error
        }
        //devuelve el servicio con el parámetro school si no se lanza ninguna excepción
    ...
    public School updateSchool(@PathVariable Long id, @RequestBody School school) {
        if(school.getSchoolName().isEmpty()) { //Verifica que el centro educativo no esté vacío
            throw new RuntimeException("Para actualizar debe ingresar un nombre al centro educativo");//Excepción manejada dentro del package error
        }
        if(school.getSchoolEmail().isEmpty()) { //Verifica que el email no esté vacío
            throw new RuntimeException("Para actualizar debe ingresar un email al centro educativo");//Excepción manejada dentro del package error
        }
        if(school.getSchoolCode().isEmpty()) { //Verifica que el código no esté vacío
            throw new RuntimeException("Para actualizar debe ingresar un código al centro educativo");//Excepción manejada dentro del package error
        }
        if(school.getSchoolTelephoneNumber().isEmpty() || !school.getSchoolTelephoneNumber().equals("-")) { //Verifica que el número telefónico no esté vacío y que no contenga guiones
            throw new RuntimeException("Para actualizar debe ingresar un número telefónico al centro educativo");//Excepción manejada dentro del package error
        }
        if(school.getSchoolQuantityTeachers() <= 0){ //Verifica que la cantidad de profesores sea mayor a 0
            throw new RuntimeException("Para actualizar la cantidad de profesores no puede ser nula");//Excepción manejada dentro del package error
        }
        if(school.getSchoolQuantityStudents() <= 0){ //Verifica que la cantidad de estudiantes sea mayor a 0
            throw new RuntimeException("Para actualizar la cantidad de estudiantes no puede ser nula");//Excepción manejada dentro del package error
        }
    ...
    public String deleteSchool(@PathVariable Long id) {//Se utiliza un PathVariable para tomar de referencia el id para eliminar el registro ingresado
        ...
        return "Centro educativo eliminado con éxito"; //Mostrará el mensaje de que se elimino correctamente el registro indicado por el id
    }
}
